...
(function () {
    ...
    // No custom-theme slot here: the suite's /api/theme mechanism needs a
    // server, and this renderer deliberately has no network access (CSP
    // connect-src 'none'). A user palette can join THEMES in a later release
    // via a settings file read in the main process.
